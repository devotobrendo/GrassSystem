...
Shader "GrassSystem/GrassUnlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local _ _LIGHTPROBES_ON
            ...
            half4 frag(Varyings input, bool isFrontFace : SV_IsFrontFace) : SV_Target
            {
                ...
                // ========================================
                // SHARED: Depth Perception (breaks visual uniformity)
                // All effects disabled by default (values = 0 = no change)
                // ========================================
                
                // Instance color variation: shifts hue slightly per-instance
                baseColor += (input.instanceVariation - 0.5) * _InstanceColorVariation;
                
                // Height darkening: roots are darker than tips
                baseColor *= lerp(1.0 - _HeightDarkening, 1.0, input.uv.y);
                
                // Backface darkening: back of blade is darker
